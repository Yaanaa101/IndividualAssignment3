...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       //
        ...
        // Able to dash multiple times
        if (Input.GetButtonDown("Fire1") && hasDashed)
        {
            currentState = PlayerState.D_DASH;
       //
       //     // As long as there is some directional input
       //     if (xRaw != 0 || yRaw != 0)
       //
       ...
       //makes player backwards ie moonwalking
        if (xInput > 0)
        {
            side = -1;
            anim.Flip(side);
    ...
    {   
        ...
        //made the dash half the speed of the original since I made it unlimited amount of dashing
